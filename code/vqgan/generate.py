...
parser.add_argument("--display_frequency", type=str, default=50,
                    help="Experiment dump path")
...
parser.add_argument("--clip_model", type=str, default="ViT-B/32",
                    help="Experiment dump path")
parser.add_argument("--vqgan_model", type=str, default="vqgan_imagenet_f16_16384",
                    help="Experiment dump path")
parser.add_argument("--initial_image", type=str, default="",
                    help="Experiment dump path")
parser.add_argument("--target_images", type=str, default="",
                    help="Experiment dump path")
parser.add_argument("--max_iterations", type=int, default=300,
                    help="Experiment dump path")
parser.add_argument("--input_images", type=str, default="",
                    help="Experiment dump path")
parser.add_argument("--vq_init_weight", type=float, default=0.0,
                    help="Experiment dump path")
parser.add_argument("--vq_step_size", type=float, default=0.1,
                    help="Experiment dump path")
parser.add_argument("--vq_cutn", type=int, default=64,
                    help="Experiment dump path")
parser.add_argument("--vq_cutpow", type=float, default=1.0,
                    help="Experiment dump path")
